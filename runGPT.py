...
def generate_code_desc_with_KG(id: str, task: str, KG: [dict], log_dir: str, sleep_time: int = 10):
    ...
    fqn_extractor = chatGPT.ChatGPT()
    permission_extractor = chatGPT.ChatGPT
    ...
    while n_attempt < max_attempt:
        ...
        for fully_qualified_method in fqn_list:
            result = search_KG(fully_qualified_method, KG)
            if result is None:
...
def main():
    ...
    # read KG
    android_kg = read_KG(cwd + "/android_kg_6.json")
    ...
    ## randomly sample 200 tasks
    # android_task_list = read_tasks_from_txt(android_task_txt)
    # random_sample_to_txt(android_task_list, 200)

    # tasks_list = read_tasks_from_txt(cwd + "/android_200_random_tasks.txt")
